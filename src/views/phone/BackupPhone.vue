...
const mockList = [
  { id: 101, cardNumber: '89860987654321001', agentId: 1, agentName: 'XX科技有限公司', phoneNumber: '13811112222', realnameId: null, realnameName: '', department: '', package_: '39元/月', cardStatus: 1, cardType: 2, remark: '库存备用卡-01', createTime: '2024-02-01 09:00:00' },
  { id: 102, cardNumber: '89860987654321002', agentId: 2, agentName: 'YY通信服务中心', phoneNumber: '13811113333', realnameId: null, realnameName: '', department: '', package_: '49元/月', cardStatus: 1, cardType: 2, remark: '库存备用卡-02', createTime: '2024-02-02 10:00:00' },
  { id: 103, cardNumber: '89860987654321003', agentId: 3, agentName: 'ZZ网络科技', phoneNumber: '13811114444', realnameId: null, realnameName: '', department: '', package_: '59元/月', cardStatus: 2, cardType: 2, remark: '需二次实名的备用卡', createTime: '2024-02-03 11:00:00' }
]
